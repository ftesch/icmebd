            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('resposta.index')" :active="request()->routeIs('resposta.*')">
                            {{ __('Respostas') }}
                        </x-nav-link>
                        <x-nav-link :href="route('ebd.index')" :active="request()->routeIs('ebd.*')">
                            {{ __('EBD') }}
                        </x-nav-link>
                        <x-nav-link :href="route('igreja.index')" :active="request()->routeIs('igreja.*')">
                            {{ __('Igrejas') }}
                        </x-nav-link>
                    </div>
                </div>
